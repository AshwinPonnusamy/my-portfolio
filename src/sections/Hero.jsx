            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
                <div className="space-y-8">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold leading-tight">
                            Building <span className="text-gradient-accent">Digital</span> <br />
                            Experiences
                        </h1>
                    </motion.div>
                    ...
                    >
                        I'm a creative developer specializing in building immersive web applications with modern technologies and clean aesthetics.
                    </motion.p>
                    ...
                    >
                        <div>
                            ...
                            <p className="text-gray-500 text-sm uppercase tracking-wider">Years Exp.</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-sm uppercase tracking-wider">Clients</p>
                        </div>
                    </motion.div>
                </div>
                ...
                >
                    <div className="relative w-full aspect-square max-w-[500px] mx-auto">
                        ...
                        <div className="absolute inset-0 bg-secondary rounded-[2rem] border border-white/10 overflow-hidden flex items-center justify-center group">
                            ...
                            <div className="relative w-full h-full bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
                                <div className="text-9xl font-bold text-white/5 select-none ">
                                    <img src="/src/assets/ashwin.jpg" alt="" className="object-cover" />

                                </div>
                                {/* Floating Elements */}
                                <div className="absolute top-10 right-10 p-4 glass rounded-2xl animate-bounce duration-[3000ms]">
                                    <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center">
                                        <span className="text-xs font-bold">R</span>
                                    </div>
                                </div>
                                <div className="absolute bottom-20 left-10 p-4 glass rounded-2xl animate-bounce duration-[4000ms]">
