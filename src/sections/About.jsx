...
const About = () => {
  ...
  const experience = [
    ...
    },
    {
      ...
      description:
        "Completed a internship focused on designing and developing responsive web pages using HTML, CSS, Bootstrap, and JavaScript. Assisted in backend integration, debugging, and teamwork to deliver production-ready features.",
    },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed mb-8">
              I am a passionate developer with a keen eye for design. I bridge
              the gap between engineering and aesthetics, ensuring that every
              project I work on not only functions perfectly but also looks
              stunning. My journey started with a curiosity for how things work
              on the web, and it has evolved into a career of building complex
              applications.
            </p>
            ...
            <div className="space-y-8 border-l-2 border-white/10 ml-3 pl-8 relative">
              {experience.map((item, index) => (
                <div key={index} className="relative">
                  ...
                  <span className="text-accent text-sm font-bold tracking-wider mb-1 block">
                    {item.year}
                  </span>
